package lateralTransshipment_lostSales;
...
public class LT2Back2_LS {
	...
	public static void detectEquivalentQuantity(int[][] inventoryPairs, int inventoryIndex, double[][] totalCost, double[][] optimalCost, int t, int[][] order) {
		...
		if(equivalentAction_Quantity_List.size()>2) {
			...
			writeEquivalentQuantity(equivalentQuantity, t, "src/main/java/lateralTransshipment_lostSales/record_quantity_sameCost.txt");}
	}
	...
	public static void detectEquivalentTransshipment(int[][] inventoryPairs, int inventoryIndex, double[][] totalCost, double[][] optimalCost, int t, int[] transshipment) {
		...
		if(equivalentAction_Transshipment_List.size()>3) {
			...
			writeEquivalentTransshipment(equivalentTransshipment, t, "src/main/java/lateralTransshipment_lostSales/record_transship_sameCost.txt");
		}
	...
	public static LTsolution compteLT2_LS(LTinstance instance, boolean noInitialTransship, boolean noInitialOrder) {
					...
					for(int a=0; a<order.length; a++) {
						...
						for(int d=0;d<demand[actualIndex].length;d++) { // Demand
							if(
								...
								if((closingState[0] > 0)&&(closingState[1] <= 0)) {
									closingState = new int[] {closingState[0],0};
								}
								if((closingState[0] <= 0)&&(closingState[1] > 0)) {
									closingState = new int[] {0, closingState[1]};
								}
	...
	public static void main(String[] args) {
		...
		for(int k=0; k<K.length; k++) {
			for(int i=0; i<noInitialTransship.length; i++) {
				...
				// record results
				LT2locationsBackwards.writeSolution(solution, "src/main/java/lateralTransshipment_lostSales/writeResults.txt");
				sdp.util.writeText.writeString("===================================================", "src/main/java/lateralTransshipment_lostSales/writeResults.txt");
				LT2locationsBackwards.convertCostMatrix(instance, solution, 0, "src/main/java/lateralTransshipment_lostSales/convertCostMatrix.txt");
				sdp.util.writeText.writeString("===================================================", "src/main/java/lateralTransshipment_lostSales/convertCostMatrix.txt");
				LT2locationsBackwards.convertActionMatrix(instance, solution, 0, "src/main/java/lateralTransshipment_lostSales/convertActionMatrix.txt");
				sdp.util.writeText.writeString("===================================================", "src/main/java/lateralTransshipment_lostSales/convertActionMatrix.txt");

				sdp.util.writeText.writeString("===================================================", "src/main/java/lateralTransshipment_lostSales/record_quantity_sameCost.txt");
				sdp.util.writeText.writeString("===================================================", "src/main/java/lateralTransshipment_lostSales/record_transship_sameCost.txt");
